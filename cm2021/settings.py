"""
Django settings for cm2021 project.
...
SECRET_KEY = 'django-insecure-hw=ddpufm&jx!#=spwt+o1^vxu7%65^2d3jy(4zj=2zhjv_6ac'
...
WSGI_APPLICATION = 'cm2021.wsgi.application'
